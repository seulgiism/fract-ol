...
/*   Updated: 2025/06/17 19:43:06 by kclaes        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void		move(t_render *render, int32_t x, int32_t y);
static void		zoom(t_render *render, double ydelta);
...
static void	zoom(t_render *render, int32_t ydelta)
{
	t_nbr_i	center;
	t_nbr_i	offset;
	double	scroll_speed;
